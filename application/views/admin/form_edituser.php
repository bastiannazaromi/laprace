						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type="text" id="input-username" class="form-control" placeholder="X" value="<?php echo $isi->nilai_x;?>" name="nil_x" required="">
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group">
									<label class="form-control-label" for="input-username">Nilai Y</label>
									<input type="text" id="input-username" class="form-control" placeholder="Y" value="<?php echo $isi->nilai_y;?>" name="nil_y" required="">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type="text" id="input-first-name" class="form-control" placeholder="W" value="<?php echo $isi->nilai_w;?>" name="nil_w" required="">
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group">
									<label class="form-control-label" for="input-last-name">Nilai H</label>
									<input type="text" id="input-last-name" class="form-control" placeholder="H" value="<?php echo $isi->nilai_h;?>" name="nil_h" required="">
								</div>
							</div>
						</div>
					</div>
